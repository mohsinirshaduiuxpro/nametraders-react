    ...
    <>
      ...
      <main>
        <Routes>
          ...
          <Route path="/MakeOffer1" element={<MakeOffer1></MakeOffer1>}></Route>
          <Route path="/MakeOffer" element={<MakeOffer2></MakeOffer2>}></Route>
          <Route path="/MakeOffer2" element={<MakeOffer3></MakeOffer3>}></Route>
          <Route
            path="/DomainForSale"
